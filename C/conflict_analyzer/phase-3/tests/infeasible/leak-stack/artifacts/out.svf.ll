...
define dso_local void @foo(i32* noundef %0) #0 !dbg !10 {
  ...
  call void @bar(i32* noundef %3), !dbg !20
  ret void, !dbg !21
}
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @bar(i32* noundef %0) #0 !dbg !22 {
  %2 = alloca i32*, align 8
  ...
  call void @llvm.var.annotation(i8* %4, i8* %5, i8* %6, i32 37, i8* null), !dbg !27
  store i32 1, i32* %3, align 4, !dbg !26
  %7 = load i32*, i32** %2, align 8, !dbg !28
  %8 = getelementptr inbounds i32, i32* %7, i64 0, !dbg !28
  store i32 5, i32* %8, align 4, !dbg !29
  ret void, !dbg !30
}
...
define dso_local i32 @main() #0 !dbg !31 {
  ...
  call void @llvm.var.annotation(i8* %3, i8* %4, i8* %5, i32 56, i8* null), !dbg !39
  %6 = bitcast [3 x i32]* %2 to i8*, !dbg !38
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %6, i8* align 4 bitcast ([3 x i32]* @__const.main.x to i8*), i64 12, i1 false), !dbg !38
  %7 = getelementptr inbounds [3 x i32], [3 x i32]* %2, i64 0, i64 0, !dbg !40
...
!1 = !DIFile(filename: "/home/mlevatich/m/build/capo/C/conflict_analyzer/phase-3/tmp-ca/prog.c", directory: "/home/mlevatich/m/build/capo/C/conflict_analyzer/phase-3/tmp-ca", checksumkind: CSK_MD5, checksum: "7a5c8939427a5e246c39ed43dfe2e593")
...
!11 = !DIFile(filename: "prog.c", directory: "/home/mlevatich/m/build/capo/C/conflict_analyzer/phase-3/tmp-ca", checksumkind: CSK_MD5, checksum: "7a5c8939427a5e246c39ed43dfe2e593")
...
!19 = !DILocation(line: 48, column: 7, scope: !10)
!20 = !DILocation(line: 48, column: 3, scope: !10)
!21 = !DILocation(line: 49, column: 1, scope: !10)
!22 = distinct !DISubprogram(name: "bar", scope: !11, file: !11, line: 32, type: !12, scopeLine: 32, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !16)
!23 = !DILocalVariable(name: "x", arg: 1, scope: !22, file: !11, line: 32, type: !14)
!24 = !DILocation(line: 32, column: 15, scope: !22)
!25 = !DILocalVariable(name: "unused", scope: !22, file: !11, line: 37, type: !15)
!26 = !DILocation(line: 37, column: 7, scope: !22)
!27 = !DILocation(line: 37, column: 3, scope: !22)
!28 = !DILocation(line: 40, column: 3, scope: !22)
!29 = !DILocation(line: 40, column: 8, scope: !22)
!30 = !DILocation(line: 41, column: 1, scope: !22)
