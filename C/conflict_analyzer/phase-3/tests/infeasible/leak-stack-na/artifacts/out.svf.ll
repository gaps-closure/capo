...
define dso_local i32 @main() #0 !dbg !29 {
  ...
  call void @llvm.var.annotation(i8* %3, i8* %4, i8* %5, i32 56, i8* null), !dbg !37
  %6 = bitcast [3 x i32]* %2 to i8*, !dbg !36
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %6, i8* align 4 bitcast ([3 x i32]* @__const.main.x to i8*), i64 12, i1 false), !dbg !36
  %7 = getelementptr inbounds [3 x i32], [3 x i32]* %2, i64 0, i64 0, !dbg !38
  call void @foo(i32* noundef %7), !dbg !39
  ret i32 0, !dbg !40
}
...
!1 = !DIFile(filename: "/home/mlevatich/m/build/capo/C/conflict_analyzer/phase-3/tmp-ca/prog.c", directory: "/home/mlevatich/m/build/capo/C/conflict_analyzer/phase-3/tmp-ca", checksumkind: CSK_MD5, checksum: "23b7f90ab728d916bd3296ad12086e1e")
...
!11 = !DIFile(filename: "prog.c", directory: "/home/mlevatich/m/build/capo/C/conflict_analyzer/phase-3/tmp-ca", checksumkind: CSK_MD5, checksum: "23b7f90ab728d916bd3296ad12086e1e")
...
!28 = !DILocation(line: 41, column: 1, scope: !22)
