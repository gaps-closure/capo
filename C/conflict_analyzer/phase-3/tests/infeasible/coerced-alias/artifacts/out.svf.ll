...
@llvm.global.annotations = appending global [1 x { i8*, i8*, i8*, i32, i8* }] [{ i8*, i8*, i8*, i32, i8* } { i8* bitcast (void (i32*)* @foo to i8*), i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([80 x i8], [80 x i8]* @.str.1, i32 0, i32 0), i32 39, i8* null }], section "llvm.metadata"
@.str = private unnamed_addr constant [13 x i8] c"ORANGE_SHARE\00", section "llvm.metadata"
@.str.1 = private unnamed_addr constant [80 x i8] c"/home/mlevatich/m/build/capo/C/conflict_analyzer/phase-3/tmp-ca/coerced-alias.c\00", section "llvm.metadata"
...
define dso_local void @foo(i32* noundef %0) #0 !dbg !10 {
  ...
  %6 = getelementptr inbounds [80 x i8], [80 x i8]* @.str.1, i32 0, i32 0
  call void @llvm.var.annotation(i8* %4, i8* %5, i8* %6, i32 44, i8* null), !dbg !21
...
define dso_local void @bar(i32* noundef %0) #0 !dbg !27 {
  ...
  %4 = getelementptr inbounds i32, i32* %3, i64 0, !dbg !30
  store i32 5, i32* %4, align 4, !dbg !31
  ret void, !dbg !32
}
...
define dso_local i32 @main() #0 !dbg !33 {
  ...
  %5 = getelementptr inbounds [80 x i8], [80 x i8]* @.str.1, i32 0, i32 0
  call void @llvm.var.annotation(i8* %3, i8* %4, i8* %5, i32 56, i8* null), !dbg !41
  %6 = bitcast [3 x i32]* %2 to i8*, !dbg !40
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %6, i8* align 4 bitcast ([3 x i32]* @__const.main.x to i8*), i64 12, i1 false), !dbg !40
  %7 = getelementptr inbounds [3 x i32], [3 x i32]* %2, i64 0, i64 0, !dbg !42
  call void @foo(i32* noundef %7), !dbg !43
  ret i32 0, !dbg !44
}
...
!1 = !DIFile(filename: "/home/mlevatich/m/build/capo/C/conflict_analyzer/phase-3/tmp-ca/coerced-alias.c", directory: "/home/mlevatich/m/build/capo/C/conflict_analyzer/phase-3/tmp-ca", checksumkind: CSK_MD5, checksum: "b761a3fdfbd452be48a6efd0be1ccbe2")
...
!10 = distinct !DISubprogram(name: "foo", scope: !11, file: !11, line: 39, type: !12, scopeLine: 39, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !16)
!11 = !DIFile(filename: "coerced-alias.c", directory: "/home/mlevatich/m/build/capo/C/conflict_analyzer/phase-3/tmp-ca", checksumkind: CSK_MD5, checksum: "b761a3fdfbd452be48a6efd0be1ccbe2")
!12 = !DISubroutineType(types: !13)
!13 = !{null, !14}
!14 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !15, size: 64)
!15 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!16 = !{}
!17 = !DILocalVariable(name: "x", arg: 1, scope: !10, file: !11, line: 39, type: !14)
!18 = !DILocation(line: 39, column: 15, scope: !10)
!19 = !DILocalVariable(name: "y", scope: !10, file: !11, line: 44, type: !14)
!20 = !DILocation(line: 44, column: 8, scope: !10)
!21 = !DILocation(line: 44, column: 3, scope: !10)
!22 = !DILocation(line: 47, column: 7, scope: !10)
!23 = !DILocation(line: 47, column: 5, scope: !10)
!24 = !DILocation(line: 48, column: 7, scope: !10)
!25 = !DILocation(line: 48, column: 3, scope: !10)
!26 = !DILocation(line: 49, column: 1, scope: !10)
...
!30 = !DILocation(line: 33, column: 3, scope: !27)
!31 = !DILocation(line: 33, column: 8, scope: !27)
!32 = !DILocation(line: 34, column: 1, scope: !27)
