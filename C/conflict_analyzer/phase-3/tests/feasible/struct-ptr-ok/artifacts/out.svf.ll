...
define dso_local i32 @main() #0 !dbg !15 {
  ...
  call void @llvm.var.annotation(i8* %4, i8* %5, i8* %6, i32 52, i8* null), !dbg !33
  %7 = getelementptr inbounds %struct.S2, %struct.S2* %2, i32 0, i32 1, !dbg !34
  store i32* @glob, i32** %7, align 8, !dbg !35
  ...
  call void @llvm.var.annotation(i8* %8, i8* %9, i8* %10, i32 58, i8* null), !dbg !38
  %11 = getelementptr inbounds %struct.S, %struct.S* %3, i32 0, i32 0, !dbg !39
  store i32* null, i32** %11, align 8, !dbg !40
  ...
  %14 = getelementptr inbounds %struct.S2, %struct.S2* %2, i32 0, i32 0, !dbg !45
  %15 = load %struct.S*, %struct.S** %14, align 8, !dbg !45
  call void @foo(%struct.S* noundef %15), !dbg !46
  ret i32 0, !dbg !47
}
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @foo(%struct.S* noundef %0) #0 !dbg !48 {
  %2 = alloca %struct.S*, align 8
  %3 = alloca i32, align 4
  store %struct.S* %0, %struct.S** %2, align 8
  call void @llvm.dbg.declare(metadata %struct.S** %2, metadata !51, metadata !DIExpression()), !dbg !52
  ...
  %7 = load %struct.S*, %struct.S** %2, align 8, !dbg !56
  %8 = getelementptr inbounds %struct.S, %struct.S* %7, i32 0, i32 1, !dbg !57
  %9 = load i32, i32* %8, align 8, !dbg !57
  %10 = getelementptr inbounds [7 x i8], [7 x i8]* @.str.3, i64 0, i64 0
  %11 = call i32 (i8*, ...) @printf(i8* noundef %10, i32 noundef %9), !dbg !58
  ret void, !dbg !59
}
...
!15 = distinct !DISubprogram(name: "main", scope: !5, file: !5, line: 47, type: !16, scopeLine: 47, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !18)
!16 = !DISubroutineType(types: !17)
!17 = !{!6}
!18 = !{}
!19 = !DILocalVariable(name: "s2", scope: !15, file: !5, line: 52, type: !20)
...
!31 = !DIDerivedType(tag: DW_TAG_member, name: "c", scope: !21, file: !5, line: 31, baseType: !29, size: 64, offset: 64)
!32 = !DILocation(line: 52, column: 6, scope: !15)
!33 = !DILocation(line: 52, column: 3, scope: !15)
!34 = !DILocation(line: 54, column: 6, scope: !15)
!35 = !DILocation(line: 54, column: 8, scope: !15)
!36 = !DILocalVariable(name: "s", scope: !15, file: !5, line: 58, type: !25)
!37 = !DILocation(line: 58, column: 5, scope: !15)
!38 = !DILocation(line: 58, column: 3, scope: !15)
!39 = !DILocation(line: 60, column: 5, scope: !15)
!40 = !DILocation(line: 60, column: 7, scope: !15)
!41 = !DILocation(line: 61, column: 5, scope: !15)
!42 = !DILocation(line: 61, column: 7, scope: !15)
!43 = !DILocation(line: 63, column: 6, scope: !15)
!44 = !DILocation(line: 63, column: 9, scope: !15)
!45 = !DILocation(line: 64, column: 10, scope: !15)
!46 = !DILocation(line: 64, column: 3, scope: !15)
!47 = !DILocation(line: 65, column: 3, scope: !15)
!48 = distinct !DISubprogram(name: "foo", scope: !5, file: !5, line: 34, type: !49, scopeLine: 34, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !18)
!49 = !DISubroutineType(types: !50)
!50 = !{null, !24}
!51 = !DILocalVariable(name: "s1", arg: 1, scope: !48, file: !5, line: 34, type: !24)
!52 = !DILocation(line: 34, column: 13, scope: !48)
!53 = !DILocalVariable(name: "unused", scope: !48, file: !5, line: 39, type: !6)
!54 = !DILocation(line: 39, column: 7, scope: !48)
!55 = !DILocation(line: 39, column: 3, scope: !48)
!56 = !DILocation(line: 42, column: 21, scope: !48)
!57 = !DILocation(line: 42, column: 25, scope: !48)
!58 = !DILocation(line: 42, column: 3, scope: !48)
!59 = !DILocation(line: 43, column: 1, scope: !48)
