...
define dso_local i32 @foo() #0 !dbg !10 {
  ...
  call void @llvm.var.annotation(i8* %2, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([71 x i8], [71 x i8]* @.str.1, i32 0, i32 0), i32 10, i8* null), !dbg !18
...
define dso_local i32 @main() #0 !dbg !21 {
  ...
  call void @llvm.var.annotation(i8* %5, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([71 x i8], [71 x i8]* @.str.1, i32 0, i32 0), i32 21, i8* null), !dbg !24
