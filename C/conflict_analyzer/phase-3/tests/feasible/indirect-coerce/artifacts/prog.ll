...
define dso_local i32 @foo() #0 !dbg !10 {
  ...
  call void @llvm.var.annotation(i8* %2, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([71 x i8], [71 x i8]* @.str.1, i32 0, i32 0), i32 24, i8* null), !dbg !18
...
!15 = !{}
!16 = !DILocalVariable(name: "a", scope: !10, file: !11, line: 24, type: !14)
!17 = !DILocation(line: 24, column: 7, scope: !10)
!18 = !DILocation(line: 24, column: 3, scope: !10)
!19 = !DILocation(line: 27, column: 10, scope: !10)
!20 = !DILocation(line: 27, column: 3, scope: !10)
!21 = distinct !DISubprogram(name: "main", scope: !11, file: !11, line: 32, type: !12, scopeLine: 32, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !15)
!22 = !DILocalVariable(name: "f", scope: !21, file: !11, line: 35, type: !23)
!23 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !12, size: 64)
!24 = !DILocation(line: 35, column: 9, scope: !21)
!25 = !DILocalVariable(name: "c", scope: !21, file: !11, line: 36, type: !14)
!26 = !DILocation(line: 36, column: 7, scope: !21)
!27 = !DILocation(line: 36, column: 13, scope: !21)
!28 = !DILocation(line: 36, column: 11, scope: !21)
!29 = !DILocation(line: 37, column: 3, scope: !21)
