; ModuleID = 'test1_orange.mod.c'
source_filename = "test1_orange.mod.c"
...
@.str.1 = private unnamed_addr constant [19 x i8] c"test1_orange.mod.c\00", section "llvm.metadata"
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @main(i32 %0, i8** %1) #0 !dbg !17 {
...
!3 = !DIFile(filename: "test1_orange.mod.c", directory: "/home/tchen/gaps/build/apps/tests/test1/partitioned/multithreaded/orange")
