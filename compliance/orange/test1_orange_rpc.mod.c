...
void _handle_requesta(__attribute__((unused))void* tag) {
    ...
    gaps_tag t_tag;
    gaps_tag o_tag;
#pragma clang attribute push (__attribute__((annotate("TAG_REQUESTA"))), apply_to = any(function,type_alias,record,enum,variable,field))
    #pragma cle begin TAG_REQUESTA
    requesta_datatype  reqA; 
    #pragma cle end TAG_REQUESTA
#pragma clang attribute pop
#pragma clang attribute push (__attribute__((annotate("TAG_RESPONSEA"))), apply_to = any(function,type_alias,record,enum,variable,field))
