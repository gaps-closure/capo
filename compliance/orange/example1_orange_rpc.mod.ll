; ModuleID = 'partitioned/multithreaded/orange/example1_orange_rpc.mod.c'
source_filename = "partitioned/multithreaded/orange/example1_orange_rpc.mod.c"
...
@.str.1 = private unnamed_addr constant [59 x i8] c"partitioned/multithreaded/orange/example1_orange_rpc.mod.c\00", section "llvm.metadata"
...
define dso_local void @_handle_requesta(i8* %tag) #0 !dbg !2 {
entry:
  ...
  %t_tag.coerce = alloca { i64, i32 }, align 4
  store i8* %tag, i8** %tag.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %tag.addr, metadata !44, metadata !DIExpression()), !dbg !45
  call void @llvm.dbg.declare(metadata %struct._tag* %t_tag, metadata !46, metadata !DIExpression()), !dbg !47
  call void @llvm.dbg.declare(metadata %struct._tag* %o_tag, metadata !48, metadata !DIExpression()), !dbg !49
  call void @llvm.dbg.declare(metadata %struct._requesta_datatype* %reqA, metadata !50, metadata !DIExpression()), !dbg !71
  %reqA1 = bitcast %struct._requesta_datatype* %reqA to i8*, !dbg !72
  call void @llvm.var.annotation(i8* %reqA1, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([59 x i8], [59 x i8]* @.str.1, i32 0, i32 0), i32 17), !dbg !72
  call void @llvm.dbg.declare(metadata %struct._responsea_datatype* %resA, metadata !73, metadata !DIExpression()), !dbg !80
  %resA2 = bitcast %struct._responsea_datatype* %resA to i8*, !dbg !81
  call void @llvm.var.annotation(i8* %resA2, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([59 x i8], [59 x i8]* @.str.1, i32 0, i32 0), i32 22), !dbg !81
  call void @tag_write(%struct._tag* %t_tag, i32 1, i32 1, i32 3), !dbg !82
  %0 = load i32, i32* @_handle_requesta.inited, align 4, !dbg !83
...
if.then:                                          ; preds = %entry
  ...
  %call = call i8* @xdc_pub_socket(), !dbg !88
  store i8* %call, i8** @_handle_requesta.psocket, align 8, !dbg !89
  %1 = bitcast { i64, i32 }* %t_tag.coerce to i8*, !dbg !90
  %2 = bitcast %struct._tag* %t_tag to i8*, !dbg !90
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %1, i8* align 4 %2, i64 12, i1 false), !dbg !90
  %3 = getelementptr inbounds { i64, i32 }, { i64, i32 }* %t_tag.coerce, i32 0, i32 0, !dbg !90
  %4 = load i64, i64* %3, align 4, !dbg !90
  %5 = getelementptr inbounds { i64, i32 }, { i64, i32 }* %t_tag.coerce, i32 0, i32 1, !dbg !90
  %6 = load i32, i32* %5, align 4, !dbg !90
  %call3 = call i8* @xdc_sub_socket(i64 %4, i32 %6), !dbg !90
  store i8* %call3, i8** @_handle_requesta.ssocket, align 8, !dbg !91
  %call4 = call i32 @sleep(i32 1), !dbg !92
  br label %if.end, !dbg !93

if.end:                                           ; preds = %if.then, %entry
  %7 = load i8*, i8** @_handle_requesta.ssocket, align 8, !dbg !94
  %8 = bitcast %struct._requesta_datatype* %reqA to i8*, !dbg !95
  call void @xdc_blocking_recv(i8* %7, i8* %8, %struct._tag* %t_tag), !dbg !96
  %call5 = call double (...) @get_a(), !dbg !97
  %a = getelementptr inbounds %struct._responsea_datatype, %struct._responsea_datatype* %resA, i32 0, i32 0, !dbg !98
  store double %call5, double* %a, align 8, !dbg !99
  call void @tag_write(%struct._tag* %o_tag, i32 2, i32 2, i32 4), !dbg !100
  %9 = load i8*, i8** @_handle_requesta.psocket, align 8, !dbg !101
  %10 = bitcast %struct._responsea_datatype* %resA to i8*, !dbg !102
  call void @xdc_asyn_send(i8* %9, i8* %10, %struct._tag* %o_tag), !dbg !103
  ret void, !dbg !104
}
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @_handle_nxtrpc(%struct._tag* %n_tag) #0 !dbg !19 {
entry:
  %n_tag.addr = alloca %struct._tag*, align 8
  %t_tag = alloca %struct._tag, align 4
  %o_tag = alloca %struct._tag, align 4
  %nxt = alloca %struct._nextrpc_datatype, align 4
  %okay = alloca %struct._okay_datatype, align 4
  %t_tag.coerce = alloca { i64, i32 }, align 4
  store %struct._tag* %n_tag, %struct._tag** %n_tag.addr, align 8
  call void @llvm.dbg.declare(metadata %struct._tag** %n_tag.addr, metadata !105, metadata !DIExpression()), !dbg !106
  call void @llvm.dbg.declare(metadata %struct._tag* %t_tag, metadata !107, metadata !DIExpression()), !dbg !108
  call void @llvm.dbg.declare(metadata %struct._tag* %o_tag, metadata !109, metadata !DIExpression()), !dbg !110
  call void @llvm.dbg.declare(metadata %struct._nextrpc_datatype* %nxt, metadata !111, metadata !DIExpression()), !dbg !119
  %nxt1 = bitcast %struct._nextrpc_datatype* %nxt to i8*, !dbg !120
  call void @llvm.var.annotation(i8* %nxt1, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([59 x i8], [59 x i8]* @.str.1, i32 0, i32 0), i32 53), !dbg !120
  call void @llvm.dbg.declare(metadata %struct._okay_datatype* %okay, metadata !121, metadata !DIExpression()), !dbg !127
  %okay2 = bitcast %struct._okay_datatype* %okay to i8*, !dbg !128
  call void @llvm.var.annotation(i8* %okay2, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([59 x i8], [59 x i8]* @.str.1, i32 0, i32 0), i32 58), !dbg !128
  call void @tag_write(%struct._tag* %t_tag, i32 1, i32 1, i32 1), !dbg !129
  %0 = load i32, i32* @_handle_nxtrpc.inited, align 4, !dbg !130
...
if.then:                                          ; preds = %entry
  ...
  %call = call i8* @xdc_pub_socket(), !dbg !135
  store i8* %call, i8** @_handle_nxtrpc.psocket, align 8, !dbg !136
  %1 = bitcast { i64, i32 }* %t_tag.coerce to i8*, !dbg !137
  %2 = bitcast %struct._tag* %t_tag to i8*, !dbg !137
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %1, i8* align 4 %2, i64 12, i1 false), !dbg !137
  %3 = getelementptr inbounds { i64, i32 }, { i64, i32 }* %t_tag.coerce, i32 0, i32 0, !dbg !137
  %4 = load i64, i64* %3, align 4, !dbg !137
  %5 = getelementptr inbounds { i64, i32 }, { i64, i32 }* %t_tag.coerce, i32 0, i32 1, !dbg !137
  %6 = load i32, i32* %5, align 4, !dbg !137
  %call3 = call i8* @xdc_sub_socket(i64 %4, i32 %6), !dbg !137
  store i8* %call3, i8** @_handle_nxtrpc.ssocket, align 8, !dbg !138
  %call4 = call i32 @sleep(i32 1), !dbg !139
  br label %if.end, !dbg !140

if.end:                                           ; preds = %if.then, %entry
  %7 = load i8*, i8** @_handle_nxtrpc.ssocket, align 8, !dbg !141
  %8 = bitcast %struct._nextrpc_datatype* %nxt to i8*, !dbg !142
  call void @xdc_blocking_recv(i8* %7, i8* %8, %struct._tag* %t_tag), !dbg !143
  call void @tag_write(%struct._tag* %o_tag, i32 2, i32 2, i32 2), !dbg !144
  %x = getelementptr inbounds %struct._okay_datatype, %struct._okay_datatype* %okay, i32 0, i32 0, !dbg !145
  store i32 0, i32* %x, align 4, !dbg !146
  %9 = load i8*, i8** @_handle_nxtrpc.psocket, align 8, !dbg !147
  %10 = bitcast %struct._okay_datatype* %okay to i8*, !dbg !148
  call void @xdc_asyn_send(i8* %9, i8* %10, %struct._tag* %o_tag), !dbg !149
  %mux = getelementptr inbounds %struct._nextrpc_datatype, %struct._nextrpc_datatype* %nxt, i32 0, i32 0, !dbg !150
  %11 = load i32, i32* %mux, align 4, !dbg !150
  %12 = load %struct._tag*, %struct._tag** %n_tag.addr, align 8, !dbg !151
  %mux5 = getelementptr inbounds %struct._tag, %struct._tag* %12, i32 0, i32 0, !dbg !152
  store i32 %11, i32* %mux5, align 4, !dbg !153
  %sec = getelementptr inbounds %struct._nextrpc_datatype, %struct._nextrpc_datatype* %nxt, i32 0, i32 1, !dbg !154
  %13 = load i32, i32* %sec, align 4, !dbg !154
  %14 = load %struct._tag*, %struct._tag** %n_tag.addr, align 8, !dbg !155
  %sec6 = getelementptr inbounds %struct._tag, %struct._tag* %14, i32 0, i32 1, !dbg !156
  store i32 %13, i32* %sec6, align 4, !dbg !157
  %typ = getelementptr inbounds %struct._nextrpc_datatype, %struct._nextrpc_datatype* %nxt, i32 0, i32 2, !dbg !158
  %15 = load i32, i32* %typ, align 4, !dbg !158
  %16 = load %struct._tag*, %struct._tag** %n_tag.addr, align 8, !dbg !159
  %typ7 = getelementptr inbounds %struct._tag, %struct._tag* %16, i32 0, i32 2, !dbg !160
  store i32 %15, i32* %typ7, align 4, !dbg !161
  ret void, !dbg !162
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @_hal_init(i8* %inuri, i8* %outuri) #0 !dbg !163 {
entry:
  %inuri.addr = alloca i8*, align 8
  %outuri.addr = alloca i8*, align 8
  store i8* %inuri, i8** %inuri.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %inuri.addr, metadata !166, metadata !DIExpression()), !dbg !167
  store i8* %outuri, i8** %outuri.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %outuri.addr, metadata !168, metadata !DIExpression()), !dbg !169
  %0 = load i8*, i8** %inuri.addr, align 8, !dbg !170
  %call = call i8* @xdc_set_in(i8* %0), !dbg !171
  %1 = load i8*, i8** %outuri.addr, align 8, !dbg !172
  %call1 = call i8* @xdc_set_out(i8* %1), !dbg !173
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i8* @_wrapper_nxtrpc(i8* %tag) #0 !dbg !179 {
entry:
  %tag.addr = alloca i8*, align 8
  store i8* %tag, i8** %tag.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %tag.addr, metadata !182, metadata !DIExpression()), !dbg !183
  br label %while.body, !dbg !183

while.body:                                       ; preds = %entry, %while.body
  %0 = load i8*, i8** %tag.addr, align 8, !dbg !184
  %1 = bitcast i8* %0 to %struct._tag*, !dbg !184
  call void @_handle_nxtrpc(%struct._tag* %1), !dbg !184
  br label %while.body, !dbg !183, !llvm.loop !186
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local i8* @_wrapper_requesta(i8* %tag) #0 !dbg !187 {
entry:
  %tag.addr = alloca i8*, align 8
  store i8* %tag, i8** %tag.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %tag.addr, metadata !188, metadata !DIExpression()), !dbg !189
  br label %while.body, !dbg !189

while.body:                                       ; preds = %entry, %while.body
  %0 = load i8*, i8** %tag.addr, align 8, !dbg !190
  call void @_handle_requesta(i8* %0), !dbg !190
  br label %while.body, !dbg !189, !llvm.loop !192
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @_slave_rpc_loop() #0 !dbg !193 {
entry:
  %n_tag = alloca %struct._tag, align 4
  %tid = alloca [2 x i64], align 16
  %i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata %struct._tag* %n_tag, metadata !196, metadata !DIExpression()), !dbg !197
  call void @llvm.dbg.declare(metadata [2 x i64]* %tid, metadata !198, metadata !DIExpression()), !dbg !205
  ...
  %arrayidx = getelementptr inbounds [2 x i64], [2 x i64]* %tid, i64 0, i64 0, !dbg !207
  %0 = bitcast %struct._tag* %n_tag to i8*, !dbg !208
  %call = call i32 @pthread_create(i64* %arrayidx, %union.pthread_attr_t* null, i8* (i8*)* @_wrapper_nxtrpc, i8* %0) #6, !dbg !209
  %arrayidx1 = getelementptr inbounds [2 x i64], [2 x i64]* %tid, i64 0, i64 1, !dbg !210
  %1 = bitcast %struct._tag* %n_tag to i8*, !dbg !211
  %call2 = call i32 @pthread_create(i64* %arrayidx1, %union.pthread_attr_t* null, i8* (i8*)* @_wrapper_requesta, i8* %1) #6, !dbg !212
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %cmp = icmp slt i32 %2, 2, !dbg !219
  br i1 %cmp, label %for.body, label %for.end, !dbg !220

for.body:                                         ; preds = %for.cond
  %3 = load i32, i32* %i, align 4, !dbg !221
  %idxprom = sext i32 %3 to i64, !dbg !222
  %arrayidx3 = getelementptr inbounds [2 x i64], [2 x i64]* %tid, i64 0, i64 %idxprom, !dbg !222
  %4 = load i64, i64* %arrayidx3, align 8, !dbg !222
  %call4 = call i32 @pthread_join(i64 %4, i8** null), !dbg !223
...
!3 = !DIFile(filename: "partitioned/multithreaded/orange/example1_orange_rpc.mod.c", directory: "/home/mkaplan/gaps/build/apps/examples/example1")
...
!24 = !DIFile(filename: "src/hal/api/xdcomms.h", directory: "/home/mkaplan/gaps/build")
...
!43 = !{!"clang version 10.0.0 (https://github.com/gaps-closure/llvm-project.git 27076be6fc363f9973ef5af6e1af3823cd6ac777)"}
...
!52 = !DIFile(filename: "partitioned/multithreaded/autogen/codec.h", directory: "/home/mkaplan/gaps/build/apps/examples/example1")
