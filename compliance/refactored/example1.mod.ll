; ModuleID = 'refactored/example1.mod.c'
source_filename = "refactored/example1.mod.c"
...
@.str.1 = private unnamed_addr constant [26 x i8] c"refactored/example1.mod.c\00", section "llvm.metadata"
...
entry:
  ...
  call void @llvm.dbg.declare(metadata double* %alpha, metadata !26, metadata !DIExpression()), !dbg !28
  store double 2.500000e-01, double* %alpha, align 8, !dbg !28
  %0 = load double, double* %a.addr, align 8, !dbg !29
  %1 = load double, double* %b.addr, align 8, !dbg !30
  %add = fadd double %0, %1, !dbg !31
  %mul = fmul double 2.500000e-01, %add, !dbg !32
  %2 = load double, double* @calc_ewma.c, align 8, !dbg !33
  %mul1 = fmul double 7.500000e-01, %2, !dbg !34
  %add2 = fadd double %mul, %mul1, !dbg !35
  store double %add2, double* @calc_ewma.c, align 8, !dbg !36
  %3 = load double, double* @calc_ewma.c, align 8, !dbg !37
  ret double %3, !dbg !38
}
...
entry:
  %0 = load double, double* @get_a.a, align 8, !dbg !39
  %add = fadd double %0, 1.000000e+00, !dbg !39
  store double %add, double* @get_a.a, align 8, !dbg !39
...
entry:
  %0 = load double, double* @get_b.b, align 8, !dbg !42
  %1 = load double, double* @get_b.b, align 8, !dbg !43
  %add = fadd double %1, %0, !dbg !43
  store double %add, double* @get_b.b, align 8, !dbg !43
...
entry:
  ...
  call void @llvm.dbg.declare(metadata double* %x, metadata !50, metadata !DIExpression()), !dbg !51
  call void @llvm.dbg.declare(metadata double* %y, metadata !52, metadata !DIExpression()), !dbg !53
  call void @llvm.dbg.declare(metadata double* %ewma, metadata !54, metadata !DIExpression()), !dbg !55
  %ewma1 = bitcast double* %ewma to i8*, !dbg !56
  call void @llvm.var.annotation(i8* %ewma1, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.1, i32 0, i32 0), i32 59), !dbg !56
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %cmp = icmp slt i32 %0, 10, !dbg !63
  br i1 %cmp, label %for.body, label %for.end, !dbg !64

for.body:                                         ; preds = %for.cond
  %call = call double @get_a(), !dbg !65
  store double %call, double* %x, align 8, !dbg !67
  %call2 = call double @get_b(), !dbg !68
  store double %call2, double* %y, align 8, !dbg !69
  %1 = load double, double* %x, align 8, !dbg !70
  %2 = load double, double* %y, align 8, !dbg !71
  %call3 = call double @calc_ewma(double %1, double %2), !dbg !72
  store double %call3, double* %ewma, align 8, !dbg !73
  %3 = load double, double* %ewma, align 8, !dbg !74
  %call4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.4, i64 0, i64 0), double %3), !dbg !75
  br label %for.inc, !dbg !76

for.inc:                                          ; preds = %for.body
  %4 = load i32, i32* %i, align 4, !dbg !77
  %inc = add nsw i32 %4, 1, !dbg !77
...
entry:
  ...
  %call = call i32 @ewma_main(), !dbg !92
  ret i32 %call, !dbg !93
}
...
!3 = !DIFile(filename: "refactored/example1.mod.c", directory: "/home/mkaplan/gaps/build/apps/examples/example1")
...
!21 = !{!"clang version 10.0.0 (https://github.com/gaps-closure/llvm-project.git 27076be6fc363f9973ef5af6e1af3823cd6ac777)"}
