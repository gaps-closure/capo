...
@llvm.global.annotations = appending global [1 x { i8*, i8*, i8*, i32 }] [{ i8*, i8*, i8*, i32 } { i8* bitcast (double ()* @_rpc_get_a to i8*), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.1, i32 0, i32 0), i32 7 }], section "llvm.metadata"
...
define dso_local double @_rpc_get_a() #0 !dbg !2 {
  ...
  call void @llvm.dbg.declare(metadata %struct._tag* %1, metadata !23, metadata !DIExpression()), !dbg !36
  call void @llvm.dbg.declare(metadata %struct._tag* %2, metadata !37, metadata !DIExpression()), !dbg !38
  call void @llvm.dbg.declare(metadata %struct._requesta_datatype* %3, metadata !39, metadata !DIExpression()), !dbg !60
  %6 = bitcast %struct._requesta_datatype* %3 to i8*, !dbg !61
  call void @llvm.var.annotation(i8* %6, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.1, i32 0, i32 0), i32 17), !dbg !61
  call void @llvm.dbg.declare(metadata %struct._responsea_datatype* %4, metadata !62, metadata !DIExpression()), !dbg !68
  %7 = bitcast %struct._responsea_datatype* %4 to i8*, !dbg !69
  call void @llvm.var.annotation(i8* %7, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.1, i32 0, i32 0), i32 22), !dbg !69
  %8 = getelementptr inbounds %struct._requesta_datatype, %struct._requesta_datatype* %3, i32 0, i32 0, !dbg !70
  store i32 0, i32* %8, align 4, !dbg !71
  call void @tag_write(%struct._tag* %1, i32 1, i32 1, i32 3), !dbg !72
  call void @tag_write(%struct._tag* %2, i32 2, i32 2, i32 4), !dbg !73
  %9 = load i32, i32* @_rpc_get_a.inited, align 4, !dbg !74
  %10 = icmp ne i32 %9, 0, !dbg !74
  br i1 %10, label %21, label %11, !dbg !76

11:                                               ; preds = %0
  store i32 1, i32* @_rpc_get_a.inited, align 4, !dbg !77
  %12 = call i8* @xdc_pub_socket(), !dbg !79
  store i8* %12, i8** @_rpc_get_a.psocket, align 8, !dbg !80
  %13 = bitcast { i64, i32 }* %5 to i8*, !dbg !81
  %14 = bitcast %struct._tag* %2 to i8*, !dbg !81
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %13, i8* align 4 %14, i64 12, i1 false), !dbg !81
  %15 = getelementptr inbounds { i64, i32 }, { i64, i32 }* %5, i32 0, i32 0, !dbg !81
  %16 = load i64, i64* %15, align 4, !dbg !81
  %17 = getelementptr inbounds { i64, i32 }, { i64, i32 }* %5, i32 0, i32 1, !dbg !81
  %18 = load i32, i32* %17, align 4, !dbg !81
  %19 = call i8* @xdc_sub_socket(i64 %16, i32 %18), !dbg !81
  store i8* %19, i8** @_rpc_get_a.ssocket, align 8, !dbg !82
  %20 = call i32 @sleep(i32 1), !dbg !83
  br label %21, !dbg !84

21:                                               ; preds = %11, %0
  %22 = load i8*, i8** @_rpc_get_a.psocket, align 8, !dbg !85
  %23 = bitcast %struct._requesta_datatype* %3 to i8*, !dbg !86
  call void @xdc_asyn_send(i8* %22, i8* %23, %struct._tag* %1), !dbg !87
  %24 = load i8*, i8** @_rpc_get_a.ssocket, align 8, !dbg !88
  %25 = bitcast %struct._responsea_datatype* %4 to i8*, !dbg !89
  call void @xdc_blocking_recv(i8* %24, i8* %25, %struct._tag* %2), !dbg !90
  %26 = getelementptr inbounds %struct._responsea_datatype, %struct._responsea_datatype* %4, i32 0, i32 0, !dbg !91
  %27 = load double, double* %26, align 8, !dbg !91
  ret double %27, !dbg !92
}
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @_hal_init(i8* %0, i8* %1) #0 !dbg !93 {
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
  store i8* %0, i8** %3, align 8
  call void @llvm.dbg.declare(metadata i8** %3, metadata !96, metadata !DIExpression()), !dbg !97
  store i8* %1, i8** %4, align 8
  call void @llvm.dbg.declare(metadata i8** %4, metadata !98, metadata !DIExpression()), !dbg !99
  %5 = load i8*, i8** %3, align 8, !dbg !100
  %6 = call i8* @xdc_set_in(i8* %5), !dbg !101
  %7 = load i8*, i8** %4, align 8, !dbg !102
  %8 = call i8* @xdc_set_out(i8* %7), !dbg !103
...
!22 = !{!"clang version 10.0.1 (https://github.com/llvm/llvm-project.git d24d5c8e308e689dcd83cbafd2e8bd32aa845a15)"}
...
!25 = !DIFile(filename: "../../../../../../src/hal/api/xdcomms.h", directory: "/home/tchen/gaps/build/apps/tests/test1/partitioned/multithreaded/purple")
...
!41 = !DIFile(filename: "../autogen/codec.h", directory: "/home/tchen/gaps/build/apps/tests/test1/partitioned/multithreaded/purple")
