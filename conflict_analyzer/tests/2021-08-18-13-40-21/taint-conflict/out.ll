...
define dso_local i32 @foo() #0 !dbg !12 {
  %1 = load i32, i32* @foo.y, align 4, !dbg !23
  %2 = add nsw i32 %1, 1, !dbg !23
  store i32 %2, i32* @foo.y, align 4, !dbg !23
  %3 = load i32, i32* @foo.y, align 4, !dbg !24
  ret i32 %3, !dbg !25
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_foo() #0 !dbg !26 {
  %1 = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %1, metadata !27, metadata !DIExpression()), !dbg !28
  %2 = call i32 @baz(), !dbg !29
  store i32 %2, i32* %1, align 4, !dbg !28
  %3 = load i32, i32* %1, align 4, !dbg !30
  %4 = call i32 @foo(), !dbg !31
...
!3 = !DIFile(filename: "out.c", directory: "/home/bflin/gaps/build/apps/conflicts/test-runs/2021-08-18-13-40-21/taint-conflict")
...
!24 = !DILocation(line: 41, column: 12, scope: !12)
!25 = !DILocation(line: 41, column: 5, scope: !12)
!26 = distinct !DISubprogram(name: "get_foo", scope: !3, file: !3, line: 46, type: !4, scopeLine: 46, spFlags: DISPFlagDefinition, unit: !7, retainedNodes: !8)
!27 = !DILocalVariable(name: "x", scope: !26, file: !3, line: 49, type: !6)
!28 = !DILocation(line: 49, column: 9, scope: !26)
!29 = !DILocation(line: 49, column: 13, scope: !26)
!30 = !DILocation(line: 50, column: 12, scope: !26)
!31 = !DILocation(line: 50, column: 16, scope: !26)
!32 = !DILocation(line: 50, column: 14, scope: !26)
