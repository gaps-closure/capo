        ...
        for constraint in constraints:
            if constraint["constraint_name"] != "":
                ...
                if "e=" in constraint["assigns"]:
                    ...
                    output.append((line1[-2].strip(),pickle.load(open(line1[-2].strip() + ".offset.pkl", "rb"))[int(line1[-1].strip())],reason))
                    output.append((line2[-2].strip(),pickle.load(open(line2[-2].strip() + ".offset.pkl", "rb"))[int(line2[-1].strip())],reason))
                    ...
                    output.append((line[-2].strip(),pickle.load(open(line[-2].strip() + ".offset.pkl", "rb"))[int(line[-1].strip())],reason))
